...
const LoginPage = () => {
  ...
  return (
    <div className="flex w-full h-[100vh]">
      ...
      <div className="w-full flex md:w-2/3 h-full bg-white dark:bg-gradient-to-b md:dark:bg-gradient-to-r from-black via-[#071b3e] to-black items-center px-10 md:px-20 lg:px-40">
        <div
          className="h-full flex flex-col items-center justify-between py-12 px-4
        sm:px-6 lg:px-8 "
        >
          ...
          <div className="max-w-md w-full space-y-8">
            ...
            <Button
              ...
              icon={<FcGoogle />}
              styles="w-full flex flex-row-revers gap-4 bg-white dark:bg-transparent text-black dark:text-white px-5 py-2.5 rounded-full border border-gray-300 "
              onClick={() => googleLogin()}
            />
